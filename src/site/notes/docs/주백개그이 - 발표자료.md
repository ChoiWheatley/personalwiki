---
{"dg-publish":true,"permalink":"/docs/주백개그이 - 발표자료/","title":"주백개그이 - 발표자료"}
---
...
![Pasted image 20230721023656.png|200](/img/user/docs/assets/Pasted%20image%2020230721023656.png)
+ RESTful한 URI 설계
+ Request & Response
+ DRF 리팩토링한 결과 함께 보기 
