---
{"dg-publish":true,"permalink":"/docs/각종 QNA 정리 {swjungle}{pintos}{project2}/","title":"각종 QNA 정리 {swjungle}{pintos}{project2}"}
---
...
- **어셈블리**
 ...
 - **plm4 and intr_frame** 
	...
	- [[docs/plm4 virtual address coverage formula {pintos}\|plm4 virtual address coverage formula {pintos}]]
...
- **fork**
	...
	- 
	- ![IMG_2858.jpg](/img/user/docs/assets/IMG_2858.jpg)
