---
{"dg-publish":true,"permalink":"/docs/Doit 자료구조와 함께 배우는 알고리즘 기초 파이썬 편/","title":"Doit 자료구조와 함께 배우는 알고리즘 기초 파이썬 편"}
---

[[docs/swjungle 🤖\|swjungle 🤖]]의 일환으로 학습한 자료를 정리한 문서입니다.
...
- [[docs/헤더와 스위트(suite) {python}\|헤더와 스위트(suite) {python}]]
- What is the algorithm?
	- 문제를 해결하기 위해 기술된 일련의 실행절차
- Decision Tree (결정트리)
	- 세 정수 a, b, c의 대소관계조합을 모두 나열해보면 트리형태를 띄게 된다. 이것을 결정트리라고 부름.
- DRY (Don't Repeat Yourself) 
	- DRY 메커니즘의 예시: 하드코딩을 피하라 [[docs/reverse를 사용해야 하는 이유 {django}\|reverse를 사용해야 하는 이유 {django}]]
...
- statement and expression
	...
	- ![Pasted image 20230812101702.png](/img/user/docs/assets/Pasted%20image%2020230812101702.png)
...
문제풀이는 전부 [[docs/index/0011 Algorithms ♾️\|algorithms]] 페이지에서 진행함.
...
- **퀵 정렬 ==p.257==**
	...
	- [[docs/20230518 estsoft - python - tree -- LIS -- selection sort -- insertion sort -- merge sort -- quick sort#quick sort\|20230518 estsoft - python - tree -- LIS -- selection sort -- insertion sort -- merge sort -- quick sort#quick sort]]
- **병합 정렬 ==p.277==**
	- [[docs/20230518 estsoft - python - tree -- LIS -- selection sort -- insertion sort -- merge sort -- quick sort#merge sort\|20230518 estsoft - python - tree -- LIS -- selection sort -- insertion sort -- merge sort -- quick sort#merge sort]]
- **힙 정렬 ==p.286==
	- [[docs/Heap\|힙]]
	- 루트를 삭제하고 힙을 재구성
...
- **도수 정렬(Counting Sort) ==p.297==**
	...
	- profit 💵
	- 아, [[docs/algorithms/수 정렬하기 3 (Counting Sort)\|수 정렬하기 3 (Counting Sort)]]
...
[[docs/tree 기초\|tree 기초]]
[[docs/graph 기초\|graph 기초]]