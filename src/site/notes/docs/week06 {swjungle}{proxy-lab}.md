---
{"dg-publish":true,"permalink":"/docs/week06 {swjungle}{proxy-lab}/","title":"week06 {swjungle}{proxy-lab}"}
---
...
- 09-18 월요일부터 [[docs/proxylab\|proxylab]] 구현 시작하기, 구체적인 것들은 일요일 브리핑 시간 전까지 조사 후 결정
...
- 지난주 못 다 읽은 챕터들
	- [[docs/9. Virtual Memory {CSAPP}\|9. Virtual Memory {CSAPP}]] 
		...
		- [[docs/⭐️ 9.9. Dynamic Memory Allocation\|⭐️ 9.9. Dynamic Memory Allocation]] 중 Segregated free list 중 **Buddy System**
