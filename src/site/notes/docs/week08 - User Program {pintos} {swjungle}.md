...
- csapp
	...
	- [[docs/8. Exceptional Control Flow\|8. Exceptional Control Flow]]  | 8.2, 8.3, 8.4
- faq
	...
	- [[docs/각종 QNA 정리 {swjungle}{pintos}{project2}\|각종 QNA 정리 {swjungle}{pintos}{project2}]]
- pintos-kaist
...
- [x] [[docs/Monitor의 condvar가 하나일 필요가 없나\|Monitor의 condvar가 하나일 필요가 없나]]
- PRJ2 질문목록을 옆에 끼고, GPT와 여러 생성형 AI를 옆에 끼고 살자. 내가 할 질문은 이미 누군가가 했을수도 있다.
- [[docs/3. Machine Level Representation of Programs {CSAPP}\|3. Machine Level Representation of Programs {CSAPP}]]에서 나오는 레지스터들과 기타 하드웨어 알아둘 지식들 [[docs/Hardware Knowledges for PintOS {swjungle}\|Hardware Knowledges for PintOS {swjungle}]]
...
- Process
	...
	- fd 복제 with [[docs/dup2(2)\|dup2(2)]]

![Pasted image 20231003145914.png](/img/user/docs/assets/Pasted%20image%2020231003145914.png)
...
- [[docs/argument passing flow {pintos}\|argument passing flow {pintos}]]
...
[[docs/Project2 User Program {wil}\|Project2 User Program {wil}]]
