...
도커를 WSL2에서 사용할 수 없길래 좀 찾아봤다. [[docs/Use docker in WSL2 distro\|Use docker in WSL2 distro]]
...
![스크린샷 2023-11-02 011628.png](/img/user/docs/assets/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-11-02%20011628.png)

그리고 이번에도 마찬가지로 [[docs/port forwarding WSL2\|port forwarding WSL2]]에서 명시한 바와 같이 파워쉘 스크립트에 포트 27017을 추가하여 원격지에서도 웹 브라우저로는 물론 3T로도 연결해 볼 수 있게 되었다.
...
- request: 
	- ![스크린샷 2023-11-02 오후 4.32.29 1.png](/img/user/docs/assets/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-11-02%20%EC%98%A4%ED%9B%84%204.32.29%201.png)
- response:
	- ![Pasted image 20231102164255.png](/img/user/docs/assets/Pasted%20image%2020231102164255.png)
